...
/* ExtractText */
    { 
    /* ExtractText */      /* procedure ExtractText */
...
#pragma code_seg(".orpc")
static const FormatInfoRef ITextExtractor_Ndr64ProcTable[] =
    {
    &__midl_frag2
    };


static const MIDL_SYNTAX_INFO ITextExtractor_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &ITextExtractor_Ndr64ProcTable[-3],
    0,
...
static const MIDL_STUBLESS_PROXY_INFO ITextExtractor_ProxyInfo =
    ...
    2,
    (MIDL_SYNTAX_INFO*)ITextExtractor_SyntaxInfo
...
static const MIDL_SERVER_INFO ITextExtractor_ServerInfo = 
    ...
    0,
    ExtractText__MIDL_ProcFormatString.Format,
    (unsigned short *) &ITextExtractor_FormatStringOffsetTable[-3],
    0,
